...
elif visualization_choice == "Perbandingan Kategori Wisata":
...
elif visualization_choice == "Distribusi Usia User":
...
elif visualization_choice == "Distribusi Harga Tiket Masuk":
...
elif visualization_choice == "Asal Kota Pengunjung":
