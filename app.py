...
# Streamlit UI
# Sidebar untuk Sistem Rekomendasi dan Visualisasi Data
with st.sidebar.beta_expander("Menu"):
    menu_selection = st.radio("Pilih Menu", ["Sistem Rekomendasi", "Visualisasi Data"])

    if menu_selection == "Sistem Rekomendasi":
